...
\subsubsection{Generiranje novčanika i konfiguracijska datoteka}
\begin{lstlisting}
    $ mkdir node
...
\subsubsection{Inicijalizacija čvorova}
...
\subsubsection{Detekcija čvorova}
...
\subsubsection{Uključivanje čvorova}
...
Parametrom "-p 80:80" se prosljeđuje \emph{port} 80 unutar kontejnera na \emph{port} 80 na uređaju na kojem se pokreće kontejner. \\
Utipkavanjem adrese "localhost:80" u željeni preglednik otvara se aplikacija i prikazuje početni ekran. \\
